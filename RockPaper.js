...
const options = {
    ...
    function GetUserOption(userEnteredText) {
        ...
        if (userEnteredText == "rock") {
            ...
            whatUserSelected1 = "NotAcceptable";
        }
        ...
        function getGameResults() {
            ...
            while (gameNumber < numOfGames) {
                ...
                if ((userEnteredText != null) && (userEnteredText != "")) {
                    ...
                    whatUserSelected = "NotAcceptable";
                }
                
                if (whatUserSelected == "NotAcceptable") {
                    isCorrectValue = "No";
                }
                if (isCorrectValue == "Yes") {
                    ...
                    lineVar = "User entered incorrect selection: " + userEnteredText;
                    console.log(lineVar);
            
                    textResults += lineVar + "\n";
                    alert ("Incorrect selection entered. Please try again");
                }
